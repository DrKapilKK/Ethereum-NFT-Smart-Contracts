...
contract SMFNFT is Ownable, Functional, ERC721, DefaultOperatorFilterer{ 
using Address for address;
    ...
    address private own1      = payable(0x84E168B16898596855f758E3f1c521927d0F955F); //70% Test
    address private own2    = payable(0x032F009A2D3E799D229b4612a5E3EF8fB8072672); //30% Test
    ...
    constructor(address _cham, address _gas, address _love) ERC721("",""){
        _name = "SMFNFT";
        _symbol = "SMFN";
        baseURI = "https://SMF.xyz/metadata/";
        ...
        maxPerWallet = 100;
        maxMintPerTx = 50;
        CT = ERC721(_cham); //Chals contract address.
    ...
    function withdraw() external onlyOwner {
        ...
        (success, ) = own2.call{value: ((sendAmount * 30) / 100)}("");
        require(success, "Transaction Unsuccessful");
        
        (success, ) = own1.call{value: ((sendAmount * 70) / 100)}("");
        require(success, "Transaction Unsuccessful");
        
        loveTokenAddress.transfer(own2, (sendLoveTokens * 30) / 100 );
        loveTokenAddress.transfer(own1, (sendLoveTokens * 70 ) / 100 );
                
        gasFactoryAddress.transfer(own2, (sendGasTokens * 30 ) / 100 );
        gasFactoryAddress.transfer(own1, (sendGasTokens * 70 ) / 100 );
    ...
    function mintByChals(uint256 [] memory qty) external reentryLock {
